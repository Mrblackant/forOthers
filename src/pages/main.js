...
class Banner extends Component {
    ...
    render() {
        return (
            <div
                style={{ height: width < 414 ? 140 : 160, width: width, overflow: 'hidden' }}
            >
                {
...
class TodayOil extends Component {
    ...
    render() {
        return (
            <div
                style={{ height: 40, backgroundColor: '#fff', paddingLeft: 12, paddingRight: 12 }}
                className='flex flex-dir flex-align-items flex-space-between'
            >
                <img
                    src={ImageConfig.oil}
...

                {
                    this.state.oilData && this.state.oilData.length > 0 ?
                        <p style={{ width: 95, color: '#444444', fontSize: 14 }}
            ...
            >
                ...
                >
                    <div style={{ height: 12, width: 2, backgroundColor: '#FE7C4C' }}
                        className="linear-gradient.flex-align-items "
                    />
                    <span style={{ paddingLeft: 12, fontSize: 14, fontWeight: 'bold' }}>享实惠</span>
                </div>
    ...
    render() {
        return (
            ...
            >
                ...
                {/*内容*/}
                <div className="flex flex-multi-line box-sizing" style={{ width: width, paddingTop: 3 }}>
                    {
                        this.lists.map((item, i) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{ width: width / 4, height: width / 4, paddingBottom: 15, flexDirection: 'column' }}
                                >
                                    <div
                                        style={{
                                        ...
                                        className="flex flex-center"
                                    >
                                        <div className={className} style={{ fontSize: i === 4 || i === 6 || i === 7 ? 20 : 25, color: '#FE7F4F' }} />
                                    </div>
...
class OwnerLife extends Component {
    ...
    render() {
        return (
            <div
                style={{ marginTop: 12, paddingBottom: '3rem' }}
                className="bg flex-space-between box-sizing"
            >
                {/*头*/}
                <div
                ...
                >
                    ...
                    >
                        ...
                        <img
                            style={{ width: width / 7.2, height: width / 7, }}
